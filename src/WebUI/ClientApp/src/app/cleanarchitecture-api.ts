...
export interface ICoronaCountriesClient {
    create(command: CreateCountryCommand): Observable<string>;
    get(): Observable<CoronaItemVm>;
}

@Injectable({
    providedIn: 'root'
})
export class CoronaCountriesClient implements ICoronaCountriesClient {
    ...
    create(command: CreateCountryCommand): Observable<string> {
        let url_ = this.baseUrl + "/api/CoronaCountries";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<CoronaItemVm>><any>_observableThrow(e);
                }
            } else
                return <Observable<CoronaItemVm>><any>_observableThrow(response_);
        }));
    }

    protected processGet(response: HttpResponseBase): Observable<CoronaItemVm> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = CoronaItemVm.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<CoronaItemVm>(<any>null);
    }
}

export interface ITodoItemsClient {
    create(command: CreateTodoItemCommand): Observable<number>;
    deleteCopy(id: number | undefined): Observable<FileResponse>;
...
export class TodoItemsClient implements ITodoItemsClient {
    ...
    deleteCopy(id: number | undefined): Observable<FileResponse> {
        ...
        return this.http.request("delete", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processDeleteCopy(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processDeleteCopy(<any>response_);
                } catch (e) {
    ...
    protected processDeleteCopy(response: HttpResponseBase): Observable<FileResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export interface IWeatherForecastClient {
    ...
    put(): Observable<WeatherForecast[]>;
}
...
export class WeatherForecastClient implements IWeatherForecastClient {
    ...
    protected processPut(response: HttpResponseBase): Observable<WeatherForecast[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class CreateCountryCommand implements ICreateCountryCommand {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.totalCases = _data["totalCases"];
            this.newCases = _data["newCases"];
...
export class CoronaItemVm implements ICoronaItemVm {
    list?: CoronaItemDto[] | undefined;

    constructor(data?: ICoronaItemVm) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
        ...
        if (_data) {
            if (Array.isArray(_data["list"])) {
                ...
                for (let item of _data["list"])
                    this.list!.push(CoronaItemDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): CoronaItemVm {
        data = typeof data === 'object' ? data : {};
        let result = new CoronaItemVm();
        result.init(data);
        return result;
    }
...
export interface ICoronaItemVm {
    list?: CoronaItemDto[] | undefined;
}

export class CoronaItemDto implements ICoronaItemDto {
    id?: string;
    title?: string | undefined;
    totalCases?: number;
    newCases?: number;
    ...
    constructor(data?: ICoronaItemDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CoronaItemDto {
        data = typeof data === 'object' ? data : {};
        let result = new CoronaItemDto();
        result.init(data);
        return result;
    }
...
export interface ICoronaItemDto {
    id?: string;
    title?: string | undefined;
    totalCases?: number;
    newCases?: number;
